...
function app_modalbox() {
  "use strict";
  jQuery(".app_all_wrap").prepend(
    '<div class="app_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
function app_page_transition() {
  "use strict";
  var section = jQuery(".app_section");
  var allLi = jQuery(".transition_link li");
  var button = jQuery(".transition_link a");
  var wrapper = jQuery(".app_all_wrap");
  var enter = wrapper.data("enter");
  var exit = wrapper.data("exit");
  button.on("click", function () {
    var element = jQuery(this);
    var href = element.attr("href");
    if (element.parent().hasClass("app_button")) {
...
function app_trigger_menu() {
  "use strict";
  var hamburger = jQuery(".app_topbar .trigger .hamburger");
  var mobileMenu = jQuery(".app_mobile_menu");
  var mobileMenuList = jQuery(".app_mobile_menu ul li a");
  ...
  mobileMenuList.on("click", function () {
    jQuery(".app_topbar .trigger .hamburger").removeClass("is-active");
    mobileMenu.removeClass("opened");
    return false;
  });
}
function app_my_progress() {
  "use strict";
...
function app_circular_progress() {
  "use strict";
...
function app_portfolio_popup() {
  "use strict";
  var modalBox = jQuery(".app_modalbox");
  var button = jQuery(".app_portfolio .portfolio_popup");
  ...
  button.off().on("click", function () {
    ...
    modalBox
      .find(".popup_details")
      .prepend(
        '<div class="top_image"><img src="' +
          image +
          '" alt="" /><div class="main" data-img-url="' +
          image +
          '"></div></div>'
      );
    modalBox
...
function app_news_popup() {
  "use strict";
  var modalBox = jQuery(".app_modalbox");
  var button = jQuery(".app_news .news_list > ul > li .post_title h3 a");
  var closePopup = modalBox.find(".close");
  button.on("click", function () {
    var element = jQuery(this);
    var parent = element.closest("li");
...
function app_service_popup() {
  "use strict";
  var modalBox = jQuery(".app_modalbox");
  var button = jQuery(".app_service .service_list ul li .app_full_link");
  var closePopup = modalBox.find(".close");
  button.on("click", function () {
    var element = jQuery(this);
    var parent = element.closest(".list_inner");
  ...
  if (myCursor.length) {
    if ($("body")) {
      ...
      (window.onmousemove = function (s) {
        ...
        $("body").on(
          "mouseenter",
          "a,.app_topbar .trigger, .cursor-pointer",
          function () {
...
function app_portfolio() {
  "use strict";
  if (jQuery().isotope) {
    var filter = jQuery(".app_portfolio .portfolio_filter ul");
    if (filter.length) {
      filter.find("a").on("click", function () {
        var element = jQuery(this);
        var selector = element.attr("data-filter");
        var list = element
          .closest(".app_portfolio")
          .find(".portfolio_list")
          .children("ul");
        list.isotope({
          filter: selector,
...
function app_mycarousel() {
  "use strict";
  var carousel = jQuery(".app_about .testimonials .owl-carousel");
...
function hashtag() {
  "use strict";
  var ccc = $(".app_header .menu .ccc");
  var element = $(".app_header .menu .active a");
  $(".app_header .menu a").on("mouseenter", function () {
    var e = $(this);
    currentLink(ccc, e);
  });
  $(".app_header .menu").on("mouseleave", function () {
    element = $(".app_header .menu .active a");
...
function currentLink(ccc, e) {
  ...
  var menuleft = $(".app_header .menu").offset().left;
...
function app_moving_box() {
  "use strict";
  var wrapper = $(".app_news");
  var list = wrapper.find(".news_list > ul > li");
  if (!$(".fn_moving_box").length) {
    $("body").append('<div class="fn_moving_box"></div>');
  }
  var box = $(".fn_moving_box");
  list
